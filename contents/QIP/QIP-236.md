...
Option 2: If this option is chosen, the collateral factor on all Polygon V1 vaults will be set to 0% exactly 2 weeks after the proposal passes. Liquidation penalties will be set to 5% for all vaults to lessen the potential impact on any v1 vault users.
